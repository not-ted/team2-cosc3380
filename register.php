<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['signupForm'])) {
		...
		//Retrive error messages from javascript
		...
		if($result && mysqli_num_rows($result) > 0) {
			...
			//$query="INSERT INTO users (firstName, lastName, uhID, email, password, securityQ1, securityQ2, securityQ3, securityA1, securityA2, securityA3) 
					//VALUES ('$fname', '$lname, '$username '$email', '$password' , '$securityQuestion1', '$securityQuestion2', '$securityQuestion3', '$securityAnswer1', '$securityAnswer2', '$securityAnswer3')";
...
<div class = "container">
	...
	<?php if(!isset($message)){ ?>
	<form method = "POST" name = "signupForm" onsubmit="return validateSignupForm()">

		<span class = "error" id = "emptyError"></span>
